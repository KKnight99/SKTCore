    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SKT Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About SKT Core"));
...
All the SKT in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SKT, 0.1 SKT, 1 SKT and 10 SKT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://monetaryunit.org\">https://monetaryunit.org</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
