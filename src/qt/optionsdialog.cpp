    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SKT-light"), QVariant("light"));
    ui->theme->addItem(QString("SKT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SKT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SKT-traditional"), QVariant("trad"));
