...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MonetaryUnit Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MonetaryUnit Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MonetaryUnit Core help message to get a list with possible MonetaryUnit Core command-line options"));
...
void BitcoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
    ...
    // Append title to "MonetaryUnit Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
