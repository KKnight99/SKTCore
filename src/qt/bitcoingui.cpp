...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About SKT Core"), this);
    aboutAction->setStatusTip(tr("Show information about SKT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SKT Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SKT Core help message to get a list with possible SKT Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SKT Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("SKT Core"); // default title
