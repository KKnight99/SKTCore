...
"transaction that are not equal 1000 SKT."),
QT_TRANSLATE_NOOP("skt-core", ""
...
QT_TRANSLATE_NOOP("skt-core", "%s - %d confirmations"),
QT_TRANSLATE_NOOP("skt-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("skt-core", "(default: %s)"),
QT_TRANSLATE_NOOP("skt-core", "(default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("skt-core", "-maxmempool must be at least %d MB"),
...
QT_TRANSLATE_NOOP("skt-core", "Accept public REST requests (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Activating best chain..."),
...
QT_TRANSLATE_NOOP("skt-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("skt-core", "Attempt to recover private keys from a corrupt wallet.dat on startup"),
QT_TRANSLATE_NOOP("skt-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("skt-core", "Automatically create Tor hidden service (default: %d)"),
QT_TRANSLATE_NOOP("skt-core", "Block creation options:"),
QT_TRANSLATE_NOOP("skt-core", "Can't denominate: no compatible inputs left."),
QT_TRANSLATE_NOOP("skt-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("skt-core", "Can't mix while sync in progress."),
...
QT_TRANSLATE_NOOP("skt-core", "Cannot resolve -whitebind address: '%s'"),
...
QT_TRANSLATE_NOOP("skt-core", "Connect through SOCKS5 proxy"),
QT_TRANSLATE_NOOP("skt-core", "Connect to KeePassHttp on port <port> (default: %u)"),
...
QT_TRANSLATE_NOOP("skt-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("skt-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("skt-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("skt-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("skt-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("skt-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("skt-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("skt-core", "Enable the client to act as a masternode (0-1, default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Enable transaction replacement in the memory pool (default: %u)"),
...
QT_TRANSLATE_NOOP("skt-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("skt-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("skt-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("skt-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("skt-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("skt-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("skt-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("skt-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("skt-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("skt-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("skt-core", "Generate coins (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("skt-core", "Importing..."),
QT_TRANSLATE_NOOP("skt-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("skt-core", "Include IP addresses in debug output (default: %u)"),
...
QT_TRANSLATE_NOOP("skt-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("skt-core", "Invalid amount for -maxtxfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("skt-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
...
QT_TRANSLATE_NOOP("skt-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("skt-core", "Invalid port detected in masternode.conf"),
...
QT_TRANSLATE_NOOP("skt-core", "Keep N SKT anonymized (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Last PrivateSend was too recent."),
QT_TRANSLATE_NOOP("skt-core", "Last successful PrivateSend action was too recent."),
QT_TRANSLATE_NOOP("skt-core", "Line: %d"),
QT_TRANSLATE_NOOP("skt-core", "Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Listen for connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Loading addresses..."),
QT_TRANSLATE_NOOP("skt-core", "Loading block index..."),
QT_TRANSLATE_NOOP("skt-core", "Loading fullfiled requests cache..."),
QT_TRANSLATE_NOOP("skt-core", "Loading governance cache..."),
QT_TRANSLATE_NOOP("skt-core", "Loading masternode cache..."),
QT_TRANSLATE_NOOP("skt-core", "Loading masternode payment cache..."),
QT_TRANSLATE_NOOP("skt-core", "Loading wallet... (%3.2f %%)"),
QT_TRANSLATE_NOOP("skt-core", "Loading wallet..."),
QT_TRANSLATE_NOOP("skt-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("skt-core", "Lock is already in place."),
QT_TRANSLATE_NOOP("skt-core", "Lock masternodes from masternode configuration file (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("skt-core", "Masternode cache is empty, skipping payments and governance cache..."),
...
QT_TRANSLATE_NOOP("skt-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("skt-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("skt-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("skt-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("skt-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("skt-core", "No errors detected."),
...
QT_TRANSLATE_NOOP("skt-core", "Node relay options:"),
...
QT_TRANSLATE_NOOP("skt-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("skt-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("skt-core", "Number of automatic wallet backups (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
QT_TRANSLATE_NOOP("skt-core", "Options:"),
QT_TRANSLATE_NOOP("skt-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("skt-core", "Port: %d"),
QT_TRANSLATE_NOOP("skt-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Print version and exit"),
QT_TRANSLATE_NOOP("skt-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("skt-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("skt-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("skt-core", "PrivateSend request incomplete:"),
QT_TRANSLATE_NOOP("skt-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("skt-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("skt-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("skt-core", "RPC server options:"),
QT_TRANSLATE_NOOP("skt-core", "Rebuild block chain index from current blk000??.dat files on startup"),
QT_TRANSLATE_NOOP("skt-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
QT_TRANSLATE_NOOP("skt-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("skt-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Session not complete!"),
QT_TRANSLATE_NOOP("skt-core", "Session timed out."),
QT_TRANSLATE_NOOP("skt-core", "Set database cache size in megabytes (%d to %d, default: %d)"),
QT_TRANSLATE_NOOP("skt-core", "Set key pool size to <n> (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("skt-core", "Set minimum block size in bytes (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Set the masternode private key"),
QT_TRANSLATE_NOOP("skt-core", "Set the number of threads to service RPC calls (default: %d)"),
...
QT_TRANSLATE_NOOP("skt-core", "Specify configuration file (default: %s)"),
QT_TRANSLATE_NOOP("skt-core", "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
QT_TRANSLATE_NOOP("skt-core", "Specify data directory"),
QT_TRANSLATE_NOOP("skt-core", "Specify masternode configuration file (default: %s)"),
QT_TRANSLATE_NOOP("skt-core", "Specify pid file (default: %s)"),
...
QT_TRANSLATE_NOOP("skt-core", "Spend unconfirmed change when sending transactions (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Submitted following entries to masternode: %u / %d"),
QT_TRANSLATE_NOOP("skt-core", "Submitted to masternode, waiting for more entries ( %u / %d ) %s"),
QT_TRANSLATE_NOOP("skt-core", "Submitted to masternode, waiting in queue %s"),
QT_TRANSLATE_NOOP("skt-core", "Synchronization failed"),
QT_TRANSLATE_NOOP("skt-core", "Synchronization finished"),
QT_TRANSLATE_NOOP("skt-core", "Synchronization pending..."),
QT_TRANSLATE_NOOP("skt-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("skt-core", "Synchronizing masternode payments..."),
QT_TRANSLATE_NOOP("skt-core", "Synchronizing masternodes..."),
QT_TRANSLATE_NOOP("skt-core", "Synchronizing sporks..."),
QT_TRANSLATE_NOOP("skt-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("skt-core", "This help message"),
QT_TRANSLATE_NOOP("skt-core", "This is experimental software."),
QT_TRANSLATE_NOOP("skt-core", "This is not a Masternode."),
QT_TRANSLATE_NOOP("skt-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("skt-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("skt-core", "Tor control port to use if onion listening enabled (default: %s)"),
...
QT_TRANSLATE_NOOP("skt-core", "Transaction too large for fee policy"),
...
QT_TRANSLATE_NOOP("skt-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("skt-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("skt-core", "Unknown response."),
QT_TRANSLATE_NOOP("skt-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("skt-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("skt-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("skt-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("skt-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("skt-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("skt-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("skt-core", "Value more than PrivateSend pool maximum allows."),
...
QT_TRANSLATE_NOOP("skt-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("skt-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("skt-core", "Whether to operate in a blocks only mode (default: %u)"),
QT_TRANSLATE_NOOP("skt-core", "Will retry..."),
QT_TRANSLATE_NOOP("skt-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("skt-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("skt-core", "Your transaction was accepted into the pool!"),
QT_TRANSLATE_NOOP("skt-core", "Zapping all transactions from wallet..."),
QT_TRANSLATE_NOOP("skt-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("skt-core", "no mixing available."),
QT_TRANSLATE_NOOP("skt-core", "see debug.log for details."),
