...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "skt" is a composite category enabling all SKT-related debug output
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\SKTCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\SKTCore
    // Mac: ~/Library/Application Support/SKTCore
    // Unix: ~/.sktcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SKTCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/SKTCore";
#else
    // Unix
