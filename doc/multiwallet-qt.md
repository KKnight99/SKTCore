...
Only requiring some minor changes is skt.cpp.
...
Changes to skt.cpp
----------------------
skt.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
