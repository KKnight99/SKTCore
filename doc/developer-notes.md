...
However, in open source software such as SKT Core, where everyone uses
...
pay attention to for reviewers of SKT Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SKT Core uses tinyformat, which is type safe. Leave them out to avoid confusion
