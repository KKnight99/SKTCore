...
This mechanism has been integrated into Bitcore-Node-SKT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sktcoin/insight-api-skt#web-socket-api](https://github.com/sktcoin/insight-api-skt#web-socket-api) 
* API: [https://github.com/sktcoin/insight-api-skt#instantsend-transactions](https://github.com/sktcoin/insight-api-skt#instantsend-transactions) 
...
By default, the SKT Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SKT Core daemon:
