...
MonetaryUnit Core version 0.12.0 is now available from:

  https://sktpay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/sktcoin/skt/issues
...
backwards-compatible with pre-0.12 versions of MonetaryUnit Core or other software:
