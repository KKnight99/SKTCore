...
*Setup instructions for a Gitian build of MonetaryUnit Core using a Debian VM or physical system.*
...
- [Building MonetaryUnit Core](#building-skt-core)
...
Clone the git repositories for MonetaryUnit Core and Gitian.
...
in the MonetaryUnit Core repository under 'Fetch and build inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the MonetaryUnit Core repository.
